    ...
    <body>
        ...
        if(duplicates($u_name) == false){
            echo '<h1>Username Available</h1>';
                if($u_passval != $u_pass){
            echo "Password DONT MATCH PLS RETRY!";                  
           //echo $u_email;
                }else{
              add_to("users", "u_fullname,u_name,u_pass,u_addr,u_email,u_tel","'".$u_fname."','".$u_name."','".$u_pass."','".$u_addr."','".$u_email."','".$u_tel."'");
              echo '<p style="text-align : center">REGISTRATION SUCCESSFUL!</p>';
              echo '<meta http-equiv="refresh" content="1; URL=log_in.php"><meta name="keywords" content="automatic redirection">';
        }
        }else{
            echo '<h1>Username Exists</h1>';
//            echo '<meta http-equiv="refresh" content="1; URL=userinfo.php"><meta name="keywords" content="automatic redirection">';
